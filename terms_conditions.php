  ...
  <section id="privacyPolicy">
    <div class="sectionWrapper">
      ...
      <p>
        ...
        this website, www.ebaluz.com (the "Website"), Ebaluz ("Business Name")
        offer of products for purchase on this Website, or your purchase of
        products available on this Website. This Agreement includes, and
        incorporates by this reference, the policies and guidelines referenced
        below. Ebaluz reserves the right to change or revise the terms and
        conditions of this Agreement at any time by posting any changes or a
        revised Agreement on this Website. Ebaluz will alert you that changes
        or revisions have been made by indicating on the top of this Agreement
        the date it was last revised. The changed or revised Agreement will be
        effective immediately after it is posted on this Website. Your use of
        the Website following the posting any such changes or of a revised
        Agreement will constitute your acceptance of any such changes or
        revisions. Ebaluz encourages you to review this Agreement whenever you
        visit the Website to make sure that you understand the terms and
        conditions governing use of the Website. This Agreement does not alter
        in any way the terms or conditions of any other written agreement you
        may have with Ebaluz for other products or services. If you do not
      ...
      <p>
        ...
        reps or direct Ebaluz sales reps, while they are calling you, of your
        desire to opt out from further direct company communications and
        solicitations, you are agreeing to continue to receive further emails
        and call solicitations Ebaluz and its designated in house or third
        party call team(s).
      </p>
      <p>
        ...
        solicitation that you may receive. 2. You may also choose to opt out,
        via sending your email address to: info@ebaluz.com.
      </p>
      <p>
        Proprietary Rights. Ebaluz has proprietary rights and trade secrets in
        the Products. You may not copy, reproduce, resell or redistribute any
        Product manufactured and/or distributed by Ebaluzt. Ebaluz also has
        rights to all trademarks and trade dress and specific layouts of this
        webpage, including calls to action, text placement, images and other
        information.
      </p>
      <p>
      ...
      <p>
        ...
        nutritional and dietary supplements. Ebaluz does not always create the
        information offered on this Website; instead the information is often
        gathered from other sources. To the extent that Ebaluz does create the
        ...
        Ebaluz does not endorse the contents on any such third-party websites.
        Ebaluz is not responsible for the content of or any damage that may
        result from your access to or reliance on these third-party websites.
        If you link to third-party websites, you do so at your own risk.
      </p>
      <p>
        Use of Website; Ebaluz is not responsible for any damages resulting
      ...
      <p>
        ...
        written authorization from Ebaluz or the applicable third party (if
      ...
      <p>
        ...
        BASIS. Ebaluz EXPRESSLY DISCLAIMS ALL WARRANTIES OF ANY KIND, WHETHER
      ...
      <p>
        Ebaluz ENTIRE LIABILITY, AND YOUR EXCLUSIVE REMEDY, IN LAW, IN EQUITY,
        OR OTHWERWISE, WITH RESPECT TO THE WEBSITE CONTENT AND PRODUCTS AND/OR
        FOR ANY BREACH OF THIS AGREEMENT IS SOLELY LIMITED TO THE AMOUNT YOU
        PAID, LESS SHIPPING AND HANDLING, FOR PRODUCTS PURCHASED VIA THE
        WEBSITE.
      </p>
      <p>
        Ebaluz WILL NOT BE LIABLE FOR ANY DIRECT, INDIRECT, INCIDENTAL,
        SPECIAL OR CONSEQUENTIAL DAMAGES IN CONNECTION WITH THIS AGREEMENT OR
        THE PRODUCTS IN ANY MANNER, INCLUDING LIABILITIES RESULTING FROM (1)
        THE USE OR THE INABILITY TO USE THE WEBSITE CONTENT OR PRODUCTS; (2)
        THE COST OF PROCURING SUBSTITUTE PRODUCTS OR CONTENT; (3) ANY PRODUCTS
        PURCHASED OR OBTAINED OR TRANSACTIONS ENTERED INTO THROUGH THE
        WEBSITE; OR (4) ANY LOST PROFITS YOU ALLEGE.
      </p>
      <p>
      ...
      <p>
        You will release, indemnify, defend and hold harmless Ebaluz, and any
        ...
        expenses, of third parties relating to or arising out of (1) this
        ...
        of the Website content; (3) the Products or your use of the Products
        (including Trial Products); (4) any intellectual property or other
        ...
        supplied to Ebaluz. When Ebaluz is threatened with suit or sued by a
        third party, Ebaluz may seek written assurances from you concerning
        your promise to indemnify Ebaluz; your failure to provide such
        assurances may be considered by Ebaluz to be a material breach of this
        Agreement. Ebaluz will have the right to participate in any defense by
        you of a third-party claim related to your use of any of the Website
        content or Products, with counsel of Ebaluz choice at its expense.
        Ebaluz will reasonably cooperate in any defense by you of a
        third-party claim at your request and expense. You will have sole
        responsibility to defend Ebaluz against any claim, but you must
        receive Ebaluz prior written consent regarding any related settlement.
      ...
      <h3>PRIVACY</h3>
      <p>
        Ebaluz believes strongly in protecting user privacy and providing you
        with notice of MuscleUP Nutrition 's use of data. Please refer to
        Ebaluz privacy policy, incorporated by reference herein, that is
      ...
      <h3>GENERAL</h3>
      <p>
        Force Majeure. Ebaluz will not be deemed in default hereunder or held
      ...
      <p>
        Cessation of Operation. Ebaluz may at any time, in its sole discretion
        and without advance notice to you, cease operation of the Website and
        distribution of the Products.
      </p>

      <p>
        Entire Agreement. This Agreement comprises the entire agreement
        between you and Ebaluz and supersedes any prior agreements pertaining
        to the subject matter contained herein.
      </p>

      <p>
        Effect of Waiver. The failure of Ebaluz to exercise or enforce any
        right or provision of this Agreement will not constitute a waiver of
        such right or provision. If any provision of this Agreement is found
      ...
      <p>
        Termination. Ebaluz reserves the right to terminate your access to the
        ...
        and Ebaluz may, in its sole discretion and without advance notice to
        you, cancel any outstanding orders for Products. If your access to the
        Website is terminated, Ebaluz reserves the right to exercise whatever
        ...
        Ebaluz chooses, in its sole discretion and without advance to you, to
        terminate it.
      </p>
      <p>
