  ...
  <section id="privacyPolicy">
    <div class="sectionWrapper">
      <h1 class="title">Privacy Policy</h2>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Ebaluz, 4047 Kembery Drive, NORTH SMITHFIELD, Rhode Island.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Ebaluz, accessible
              from
              <a href="www.ebaluz.com" rel="external nofollow noopener" target="_blank">www.ebaluz.com</a>
            </p>
          </li>
          <li>
            <p>
        ...
        <ul>
          <li>By email: info@ebaluz.com</li>
        </ul>
    </div>
  </section>
